# CS2Interface-String-Scanner

**CS2Interface-String-Scanner** is a fast, multithreaded C++ tool for scanning and dumping interface-like strings from loaded modules in a running CS2 (Counter-Strike 2) game process.  
